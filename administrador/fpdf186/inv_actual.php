...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(0, 6, utf8_decode('Inventario Actual'), 0, 1, 'C'); // Agrega el titulo centrado
...
$consulta = "SELECT id_articulo, nombre, descripcion, cantidad,tipo FROM articulos WHERE estatus = 'activo'";
