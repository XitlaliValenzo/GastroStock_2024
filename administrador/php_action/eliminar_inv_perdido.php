<?php 
 	...
 	if($_POST){
 		...
 		//cantidad que ya existe en la tabla de articulos _perdidos
		...
		$sql1 = "UPDATE articulos_perdidos SET cantidad = '$cantidad_total' WHERE articulo_perdido = {$id_articulo}";
			...
			if($con->query($sql1)){
 			...
 			$sql1 = "DELETE FROM comentarios_perdidos WHERE articulo_perdido = {$id_articulo}";
 			$sql2 = "DELETE FROM articulos_perdidos WHERE articulo_perdido = {$id_articulo}";
