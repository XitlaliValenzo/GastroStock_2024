...
case '11':
  ...
  <div class='modal-dialog'>
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <center><p class='lead'>¡El material ha sido reañadido exitosamente!</p>
  ...
  <div class='modal-dialog'>
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <center><p class='lead'>¡La cantidad debe ser menor o igual a la existente en reparación / mantenimiento!</p>
    ...
    <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Inventario en Mantenimiento / Reparación</h1>
                        <br>
                        <hr>
                        <br>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
          $sql = "SELECT articulos_reparacion.cantidad AS cantidad_reparacion,articulos_reparacion.*,articulos.cantidad AS cantidad_articulos,articulos.* FROM articulos_reparacion INNER JOIN articulos ON articulos_reparacion.articulo_reparacion = articulos.id_articulo WHERE articulos.estatus ='activo' ";
    ...
    <img src="<?php echo htmlspecialchars($rutaImagen); ?>" class="card-img-top" alt="Imagen" style="width: 90px; height: 90px; margin: auto;">
                  ...
                  <td><?php echo ucfirst($row['descripcion'])?></td>
                    ...
                    <div class="container-fluid text-center">
                      <a href="#" class="text-danger" data-toggle="modal" data-target="#exampleModal2_<?php echo $i ?>"><?php echo $row['cantidad_reparacion'] ?></a></div>
  <!-- Modal -->
      ...
      <div class="modal-body">
        <ul>
                  ...
                  $resultReparacion = $con->query($sqlReparacion);
                   while ($rowD = $resultReparacion->fetch_assoc()) { ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="php_action/reanadir_cantidad_mantenimiento.php" method="POST">
          <div class="form-group">
    <label for="cantidad_agregar">Ingresa la cantidad a reañadir</label>
    <input type="number" class="form-control" id="cantidad_agregar" value="0" name="cantidad_agregar">
  </div>
      ...
      <input type="hidden" name="cantidad_stock" value="<?php echo $row['cantidad_reparacion']?>">
      <input type="hidden" name="cantidad_articulos" value="<?php echo $row['cantidad_articulos']?>">
    
      
      <button type="submit" class="btn btn-danger">Añadir material</button>
      </form>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                  ...
                  <td class="text-center">
                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#exampleModal6_<?php echo $i ?>">
  <i class="fa-solid fa-trash"></i>
</button>

<!-- Modal -->
<div class="modal fade" id="exampleModal6_<?php echo $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form action="php_action/eliminar_inv_mantenimiento.php" method="POST">
    ...
    <input type="number" class="form-control" id="cantidad" value="0" name="cantidad">
      ...
      <button type="submit" class="btn btn-danger">Realizar</button>
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
            ...
            echo "<tr> <td colspan='6'> <center>No existen materiales en mantenimiento o reparación</center></td></tr>";
          }
        ?>                      
        ...
        <a href="fpdf186/inv_mantenimiento.php"><button type="button" class="btn btn-primary shadow " style="border-radius: 50px;"><i class="fa-solid fa-download"></i> Descargar</button></a>
