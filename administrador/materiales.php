  ...
  <div class="form-group" id="campo_oculto_eliminar_cant_<?php echo $i ?>" style="display: none">
      ...
      <div class="d-flex container-fluid justify-content-end fixed-bottom p-5">
        <ul class="custom-list">
            ...
            <li>
               <a href="php_action/csv_materiales.php"><button type="button" class="btn btn-primary shadow" style="border-radius: 50px;color:#fff;"><i class="fa-solid fa-download"></i> Descargar CSV</button></a>
            </li>
        </ul>
    </div>
        </main>
