	...
	<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Inventario de material dañado</h1>
                        <br>
                        <hr>
                        <br>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
          $sql = "SELECT articulos.*,articulos.cantidad as cantidad_articulos,articulos_danados.cantidad as cantidad_danada, articulos_danados.* FROM articulos INNER JOIN articulos_danados ON articulos.id_articulo = articulos_danados.articulo_danado WHERE articulos.estatus = 'activo'";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="php_action/agregar_cantidad_danada.php" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="cantidad_danados" value="<?php echo $row['cantidad_danada']?>">
    ...
    <img src="<?php echo htmlspecialchars($rutaImagen); ?>" class="card-img-top" alt="Imagen" style="width: 90px; height: 90px; margin: auto;">
                  ...
                  <td><?php echo ucfirst($row['descripcion'])?></td>
                   <td class="text-center"><?php echo $row['cantidad_danada'] ?></td>
                   <td>
      ...
      <div class="modal-body text-justify">
        <ul>
            <?php 
              ...
              $sqlComentario = "SELECT * FROM comentarios_danados WHERE articulo_danado = $id_articulo ";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="php_action/reparar_material.php" method="POST">
    <div class="form-group">
      <label for="cantidad_agregar">Cantidad</label>
      <input type="number" class="form-control" id="cantidad_agregar" name="cantidad_agregar" value="1" min="1" required>
    </div>
     <div class="form-group">
      ...
      <button type="submit" class="btn btn-danger">Reparación</button>
       ...
       <?php } else { ?>
        ...
        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModal5_<?php echo $i ?>">
  <i class="fa-solid fa-arrows-rotate"></i>
</button></div>

<!-- Modal -->
<div class="modal fade text-justify" id="exampleModal5_<?php echo $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form action="php_action/reanadir_cantidad_danada.php" method="POST">
        <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="php_action/eliminar_inv_danado.php" method="POST">
    ...
    <input type="number" class="form-control" id="cantidad" value="0" name="cantidad">
      ...
      <button type="submit" class="btn btn-danger">Realizar</button>
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
            ...
            echo "<tr> <td colspan='8'> <center>No existen materiales dañados</center></td></tr>";
          }
        ?>                      
        ...
        <a href="fpdf186/inv_danado.php"><button type="button" class="btn btn-primary shadow " style="border-radius: 50px;"><i class="fa-solid fa-download"></i> Descargar</button></a>
