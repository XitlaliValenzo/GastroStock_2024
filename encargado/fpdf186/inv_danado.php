...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(0, 6, utf8_decode('Inventario de Materiales Dañados'), 0, 1, 'C'); // Agrega el titulo centrado
...
$consulta = "SELECT articulos.id_articulo,articulos.nombre,articulos.descripcion, comentarios_danados.cantidad,comentarios_danados.comentario,comentarios_danados.fecha FROM articulos INNER JOIN comentarios_danados ON articulos.id_articulo = comentarios_danados.articulo_danado WHERE articulos.estatus = 'activo' ORDER BY id_articulo";
