...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(0, 6, utf8_decode('Inventario de Equipos (electrodomésticos)'), 0, 1, 'C'); // Agrega el titulo centrado
        ...
        $this->Cell($widths['cantidad_articulos'], 10, utf8_decode('Cantidad'), 1, 0, 'C', true);
        $this->Cell($widths['tipo'], 10, utf8_decode('Tipo'), 1, 1, 'C', true);
    }
...
$consulta = "SELECT id_articulo,nombre,descripcion, articulos.cantidad as cantidad_articulos,tipo FROM articulos 
                  ...
                  UNION
                  SELECT id_articulo,nombre,descripcion, articulos.cantidad as cantidad_articulos,tipo FROM articulos 
