...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(0, 6, utf8_decode('Inventario dado de baja'), 0, 1, 'C'); // Agrega el titulo centrado
...
$consulta = "SELECT articulos.id_articulo, articulos.nombre, articulos.descripcion, articulos_eliminados.cantidad FROM articulos INNER JOIN articulos_eliminados ON articulos.id_articulo = articulos_eliminados.articulo_eliminado ORDER BY id_articulo";
