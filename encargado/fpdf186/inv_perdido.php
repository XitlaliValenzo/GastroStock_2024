...
$consulta = "SELECT articulos.id_articulo,articulos.nombre,articulos.descripcion, comentarios_perdidos.cantidad,comentarios_perdidos.comentario,comentarios_perdidos.fecha FROM articulos INNER JOIN comentarios_perdidos ON articulos.id_articulo = comentarios_perdidos.articulo_perdido WHERE articulos.estatus = 'activo' ORDER BY id_articulo";
