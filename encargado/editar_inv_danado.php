...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <hr>
                        <br>
                        <form action="php_action/actualizar_inv_danado.php" method="POST" enctype="multipart/form-data">
                            <div class="container">
  ...
  <div class="d-flex container-fluid justify-content-end">
              ...
              <a href="inv_danado.php" class="btn btn-outline-info" role="button"><i class="fa-solid fa-arrow-left"></i> Atrás</a>
