  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="php_action/agregar_cantidad.php" method="POST">
      ...
      <button type="submit" class="btn btn-danger">Actualizar</button>
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                  ...
                  <td class="text-center">
                    <div class="container-fluid text-center">
                    <a href="editar_material.php?id=<?php echo $row['id_articulo'] ?>" class="btn btn-outline-primary" role="button"><i class="fa-solid fa-pencil"></i> </a>
                    </div>
                  </td>
                  <td class="text-center">
  ...
  <div class="form-group" id="campo_oculto_eliminar_cant_<?php echo $i ?>" style="display: none">
        ...
        <ul class="custom-list">
            <li>
                <a href="form_material.php">
                    <button type="button" class="btn shadow" style="border-radius: 50px; background-color: #2FC463; color: #fff;">
                        <i class="fa-solid fa-circle-plus"></i> Añadir material
                    </button>
                </a>
            </li>
            <li>
                <a href="../administrador/php_action/csv_materiales.php"><button type="button" class="btn btn-primary shadow " style="border-radius: 50px;color:#fff;"><i class="fa-solid fa-download"></i> Descargar CSV</button></a>
            </li>
            <!-- <li>
                <button type="button" class="btn shadow" style="border-radius: 50px; background-color: #2FC463; color: #fff;" data-toggle="modal" data-target="#importModal">
                    <i class="fa-solid fa-circle-plus"></i> Añadir varios materiales
                </button>
            </li>-->
        </ul>
    </div>
      <br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importModalLabel">Importar Varios Articulos</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="php_action/importar_multiples_articulos.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                        ...
                        <button type="submit" name="import" class="btn btn-primary">Importar Articulos</button>
                    </form>
                </div>
            </div>
        </div>
