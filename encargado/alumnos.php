  ...
  $(document).ready(function(){
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $solicitud = $resultSolicitudes->num_rows > 0 ? "<a href='fpdf186/requisicion_alumno.php?id={$row['id']}' class='btn btn-outline-success' role='button'><i class='fa-solid fa-file'></i> </a>" : "<i class='fa-solid fa-ban'></i>";
                ...
                echo "<tr>
                    ...
                    <td>
                        <div class='container-fluid text-center'>
                            <a href='editar_alumno.php?id={$row['id']}' class='btn btn-outline-primary' role='button'><i class='fa-solid fa-pencil'></i> </a>
                        </div>
                    </td>
    ...
    <br>
        ...
        <ul class="custom-list">
            <li>
                <a href="form_alumnos.php">
                    <button type="button" class="btn shadow" style="border-radius: 50px; background-color: #2FC463; color: #fff;">
                        <i class="fa-solid fa-circle-plus"></i> Añadir alumno
                    </button>
                </a>
            </li>
            <li>
                <a href="../administrador/php_action/csv_alumnos.php"><button type="button" class="btn btn-primary shadow " style="border-radius: 50px;color:#fff;"><i class="fa-solid fa-download"></i> Descargar CSV</button></a>
            </li>
            <li>
                <button type="button" class="btn btn-danger shadow" style="border-radius: 50px; color: #fff;" data-toggle="modal" data-target="#importModal">
                    <i class="fa-solid fa-users"></i> Carga masiva
                </button>
            </li>
        </ul>
    </div>
